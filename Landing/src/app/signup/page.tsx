  ...
  return (
    <>
      <section className="relative z-10 flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-blue-50 to-white dark:from-slate-900 dark:to-slate-950">
        {/* Círculos azules difuminados de fondo */}
        ...
        <div className="container px-4">
          <div className="mx-auto max-w-[500px] rounded-2xl bg-white/70 p-10 shadow-xl backdrop-blur-md dark:bg-slate-800/70">
            ...
            {/* Botón Google */}
            <button className="mb-4 flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-6 py-3 text-gray-700 transition-all duration-300 hover:bg-blue-50 dark:border-gray-700 dark:bg-slate-700 dark:text-gray-100 dark:hover:bg-slate-600">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
