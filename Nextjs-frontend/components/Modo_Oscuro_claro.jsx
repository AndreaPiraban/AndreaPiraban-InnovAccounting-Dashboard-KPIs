...
export default function ThemeToggle() {
  ...
  useEffect(() => {
    // Detectar tema inicial (localStorage o preferencias del sistema)
  ...
  return (
    ...
    >
      {/* Ícono de luna (para modo claro → cambia a oscuro) */}
      {!isDark && (
        <svg
          className="w-5 h-5"
          fill="currentColor"
      ...
      {/* Ícono de sol (para modo oscuro → cambia a claro) */}
      {isDark && (
        <svg
          className="w-5 h-5"
          fill="currentColor"
        ...
        >
          <path
            ...
            d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 
              ...
              4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 
              011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 
              00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 
              0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 
